package com.qrent.apigateway.ApiGateway.filters;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;

import com.qrent.apigateway.model.Authorities;
import com.qrent.apigateway.model.ConnValidationResponse;
import com.qrent.apigateway.utils.SecurityConstants;
...
public class AuthenticationPrefilter extends AbstractGatewayFilterFactory<AuthenticationPrefilter.Config> {
    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            if(true
                    //isSecured.test(request)
             ) {
                return webClientBuilder.build().get()
                        .uri("http://localhost:8502/api/v1/validateToken")
